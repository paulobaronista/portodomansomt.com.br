...
$(document).ready(function(){
  $("#abrir-zoom").on("click",function() {
    $('#poup-zoom').css("visibility","visible");
      return false;
  });
  $("#fechar-zoom").on("click",function() {
    $('#poup-zoom').css("visibility","hidden");
      return false;
  });
  ...
  $.fn.extend({
    blueberry: function(options) {
     ...
     $(".enviar").on("click",function() {
       ...
       //Telefone
       if($("input.statusphone").val() == "")
       {
         erros = 1;
         $("input.statusphone").css({
           "background":"#fe7575",
           "color":"#FFF"
         });
         $("input.statusphone").attr("placeholder","Campo email está vazio")
